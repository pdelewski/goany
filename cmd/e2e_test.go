...
var e2eTestCases = []TestCase{
	{"lang-constructs", "../tests/lang-constructs", true, true, true, true, true, true, true, true, true},
	{"containers", "../examples/containers", true, true, true, true, true, true, true, true, false},
	{"uql", "../examples/uql", true, true, true, true, true, true, true, true, false},
	{"ast-demo", "../examples/ast-demo", true, true, true, true, true, true, true, true, false},
	{"python-parser-demo", "../examples/python-parser-demo", true, true, true, true, true, true, true, true, true},
	{"go-parser-demo", "../examples/go-parser-demo", true, true, true, true, true, true, true, true, true},
	{"graphics-minimal", "../examples/graphics-minimal", true, true, true, false, true, true, false, true, false},       // Dotnet/JS/Java: transpile only (needs graphics)
	{"graphics-demo", "../examples/graphics-demo", true, true, true, false, true, true, false, true, false},             // Dotnet/JS/Java: transpile only (needs graphics)
	{"gui-demo", "../examples/gui-demo", true, true, true, false, true, true, false, true, false},                       // Dotnet/JS/Java: transpile only (needs graphics)
	{"mos6502-graphic", "../examples/mos6502/cmd/graphic", true, true, true, false, true, true, false, true, false},     // Dotnet/JS/Java: transpile only (needs graphics)
	{"mos6502-text", "../examples/mos6502/cmd/text", true, true, true, false, true, true, false, true, false},           // Dotnet/JS/Java: transpile only (needs graphics)
	{"mos6502-textscroll", "../examples/mos6502/cmd/textscroll", true, true, true, false, true, true, false, true, false}, // Dotnet/JS/Java: transpile only (needs graphics)
	{"mos6502-c64", "../examples/mos6502/cmd/c64", true, true, true, false, true, true, false, true, false},             // Dotnet/JS/Java: transpile only (needs graphics)
	{"mos6502-c64-v2", "../examples/mos6502/cmd/c64-v2", true, true, true, false, true, true, false, true, false},       // Dotnet/JS/Java: transpile only (needs graphics)
	{"http-client", "../examples/http/client", true, true, true, false, true, true, false, true, false},
	{"http-server", "../examples/http/server", true, true, true, false, true, true, false, true, false},
	{"fs-demo", "../examples/fs-demo", true, true, true, true, true, true, true, true, true},
	{"net-demo", "../examples/net/demo", true, true, true, false, true, true, false, true, false},                       // JS transpile only (needs deasync npm package)
	{"net-echo-server", "../examples/net/echo-server", true, true, true, false, true, true, false, true, false},         // Server example - transpile/compile only
	{"net-echo-client", "../examples/net/echo-client", true, true, true, false, true, true, false, true, false},         // Client example - transpile/compile only
	{"python-interp-demo", "../examples/python-interp-demo", true, true, true, true, true, true, true, true, true},
}
...
func runE2ETest(t *testing.T, wd, buildDir string, tc TestCase) {
	...
	// Add opt-in backends (JS, Java, CppPrim are not included in "all")
	...
	if tc.CppPrimEnabled {
		optInBackends = append(optInBackends, "cppprim")
	}
	...
	// Step 2b: Compile C++ (prim) using make -f Makefile.cppprim
	if tc.CppPrimEnabled {
		t.Logf("Compiling C++ (prim) for %s", tc.Name)
		cmd = exec.Command("make", "-f", "Makefile.cppprim")
		cmd.Dir = outputDir
		output, err = cmd.CombinedOutput()
		if err != nil {
