...
// RustPrimEmitter implements the Emitter interface using a shift/reduce FragmentStack
// architecture for Rust code generation.
type RustPrimEmitter struct {
	fs              *FragmentStack
	Output          string
	OutputDir       string
	OutputName      string
...
func (e *RustPrimEmitter) GetFile() *os.File     { return e.file }

// rustpIndent returns indentation string for the given level.
func rustpIndent(indent int) string {
...
func (e *RustPrimEmitter) getExprGoType(expr ast.Expr) types.Type {
...
func (e *RustPrimEmitter) isMapTypeExpr(expr ast.Expr) bool {
	if e.pkg == nil || e.pkg.TypesInfo == nil {
		return false
	}
	tv := e.pkg.TypesInfo.Types[expr]
...
func (e *RustPrimEmitter) emitMapSliceAssign(outerIdx *ast.IndexExpr, rhsStr string, ind string) string {
...
func (e *RustPrimEmitter) emitMapAssign(node *ast.AssignStmt, rhsStr string, ind string) string {
...
func (e *RustPrimEmitter) mapGoTypeToRust(goType string) string {
...
func (e *RustPrimEmitter) qualifiedRustTypeName(t types.Type) string {
...
func (e *RustPrimEmitter) castSmallIntFieldValue(fieldType types.Type, val string) string {
...
func (e *RustPrimEmitter) cloneStructFieldValue(fieldType types.Type, val string) string {
...
func (e *RustPrimEmitter) getMapKeyTypeConst(mapType *ast.MapType) int {
...
func (e *RustPrimEmitter) rustDefaultForGoType(t types.Type) string {
	if t == nil {
...
func (e *RustPrimEmitter) isTypeConversion(funName string) (bool, string) {
...
func (e *RustPrimEmitter) lowerToBuiltins(selector string) string {
	switch selector {
	case "fmt":
		return ""
	case "Sprintf":
...
func (e *RustPrimEmitter) structHasInterfaceFields(structName string) bool {
	return e.structHasInterfaceFieldsRecursive(structName, make(map[string]bool))
}

func (e *RustPrimEmitter) structHasInterfaceFieldsRecursive(structName string, visited map[string]bool) bool {
...
func (e *RustPrimEmitter) structHasFunctionFields(structName string) bool {
	for _, file := range e.pkg.Syntax {
		for _, decl := range file.Decls {
			if genDecl, ok := decl.(*ast.GenDecl); ok {
				for _, spec := range genDecl.Specs {
...
func (e *RustPrimEmitter) structCanDeriveCopy(structName string) bool {
	for _, file := range e.pkg.Syntax {
		for _, decl := range file.Decls {
			if genDecl, ok := decl.(*ast.GenDecl); ok {
				for _, spec := range genDecl.Specs {
...
func (e *RustPrimEmitter) isCopyableType(t types.Type, visited map[string]bool) bool {
	if named, ok := t.(*types.Named); ok {
		name := named.Obj().Name()
...
func (e *RustPrimEmitter) structCanDeriveHash(structName string) bool {
	for _, file := range e.pkg.Syntax {
		for _, decl := range file.Decls {
			if genDecl, ok := decl.(*ast.GenDecl); ok {
				for _, spec := range genDecl.Specs {
...
func (e *RustPrimEmitter) isHashableType(t types.Type, visited map[string]bool) bool {
	if named, ok := t.(*types.Named); ok {
		name := named.Obj().Name()
		if named.Obj().Pkg() != nil {
			name = named.Obj().Pkg().Path() + "." + name
...
func (e *RustPrimEmitter) PreVisitProgram(indent int) {
...
func (e *RustPrimEmitter) PostVisitProgram(indent int) {
...
func (e *RustPrimEmitter) PostVisitPackage(pkg *packages.Package, indent int) {
	if pkg.Name != "main" {
		e.fs.PushCode(fmt.Sprintf("} // pub mod %s\n\n", pkg.Name))
	}
}
...
func (e *RustPrimEmitter) PreVisitFuncDeclSignatures(indent int) {
	e.forwardDecl = true
}

func (e *RustPrimEmitter) PostVisitFuncDeclSignatures(indent int) {
...
func (e *RustPrimEmitter) PreVisitFuncDeclSignatureTypeResults(node *ast.FuncDecl, indent int) {
	e.numFuncResults = 0
...
func (e *RustPrimEmitter) PostVisitFuncDeclSignatureTypeResultsList(node *ast.Field, index int, indent int) {
	typeCode := e.fs.ReduceToCode(string(PreVisitFuncDeclSignatureTypeResultsList))
	e.fs.PushCode(typeCode)
}

func (e *RustPrimEmitter) PostVisitFuncDeclSignatureTypeResults(node *ast.FuncDecl, indent int) {
...
func (e *RustPrimEmitter) PostVisitFuncDeclSignatureTypeParamsArgName(node *ast.Ident, index int, indent int) {
	e.fs.Reduce(string(PreVisitFuncDeclSignatureTypeParamsArgName))
	e.fs.Push(node.Name, TagIdent, nil)
}

func (e *RustPrimEmitter) PostVisitFuncDeclSignatureTypeParamsList(node *ast.Field, index int, indent int) {
...
func (e *RustPrimEmitter) PostVisitFuncDeclSignature(node *ast.FuncDecl, indent int) {
...
func (e *RustPrimEmitter) PostVisitFuncDeclBody(node *ast.BlockStmt, indent int) {
	bodyCode := e.fs.ReduceToCode(string(PreVisitFuncDeclBody))
	e.fs.PushCode(bodyCode)
}

func (e *RustPrimEmitter) PostVisitFuncDecl(node *ast.FuncDecl, indent int) {
...
func (e *RustPrimEmitter) PreVisitBlockStmt(node *ast.BlockStmt, indent int) {
	e.indent = indent
}

func (e *RustPrimEmitter) PostVisitBlockStmtList(node ast.Stmt, index int, indent int) {
	itemCode := e.fs.ReduceToCode(string(PreVisitBlockStmtList))
	e.fs.PushCode(itemCode)
}

func (e *RustPrimEmitter) PostVisitBlockStmt(node *ast.BlockStmt, indent int) {
	...
	sb.WriteString(rustpIndent(indent/2) + "}")
...
func (e *RustPrimEmitter) PostVisitGenStructFieldType(node ast.Expr, indent int) {
	typeCode := e.fs.ReduceToCode(string(PreVisitGenStructFieldType))
	e.fs.PushCode(typeCode)
}

func (e *RustPrimEmitter) PostVisitGenStructFieldName(node *ast.Ident, indent int) {
	e.fs.Reduce(string(PreVisitGenStructFieldName))
	e.fs.Push(node.Name, TagIdent, nil)
}

func (e *RustPrimEmitter) PostVisitGenStructInfo(node GenTypeInfo, indent int) {
...
func (e *RustPrimEmitter) PostVisitGenStructInfos(node []GenTypeInfo, indent int) {
...
func (e *RustPrimEmitter) PostVisitGenDeclConstName(node *ast.Ident, indent int) {
...
func (e *RustPrimEmitter) PostVisitGenDeclConst(node *ast.GenDecl, indent int) {
...
func (e *RustPrimEmitter) PreVisitTypeAliasName(node *ast.Ident, indent int) {
	e.currentAliasName = node.Name
}

func (e *RustPrimEmitter) PostVisitTypeAliasType(node ast.Expr, indent int) {
...
func (e *RustPrimEmitter) replaceStructKeyFunctions() {
	outputPath := e.Output
	if e.LinkRuntime != "" {
...
func (e *RustPrimEmitter) GenerateCargoToml() error {
	if e.LinkRuntime == "" {
		return nil
	}
...
func (e *RustPrimEmitter) GenerateBuildRs() error {
	if e.LinkRuntime == "" {
		return nil
	}
	graphicsBackend := e.RuntimePackages["graphics"]
...
func (e *RustPrimEmitter) CopyRuntimeMods() error {
	if e.LinkRuntime == "" {
		return nil
	}
	srcDir := filepath.Join(e.OutputDir, "src")
